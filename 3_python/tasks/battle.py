    ...
    def get_name_and_ships(self):
        ...
        while True:
            try:
                int(
                    input(
                        "{}, please, enter the number of ships fom 1 to 10. : ".format(
                            first_name
                        )
                    )
                )
                ...
                print("{}, please, enter correct number of ships!".format(first_name))
                continue
        ...
        while True:
            try:
                ...
                print("{}, please, enter correct number of ships!".format(second_name))
                continue

    def take_power_away(self):
        """This function calculated the power."""
        print(
            'Press "1" if you first player and "2" if second, when you want to shoot.'
        )
        ...
        while first_power_status[-1] or second_power_status[-1] != 0:
            ...
            if press_enter == "1":
                ...
                print(
                    "You take {} power from second player!".format(
                        100 - second_power_status[-1]
                    )
                )
                ...
                print(
                    "You take {} power from first player!".format(
                        100 - first_power_status[-1]
                    )
                )
